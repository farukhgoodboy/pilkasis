...
<html lang="id">
  <head>
    ...
    <title>Pemilihan Ketua Osis SMKN 8 Jember</title>
...
<body>
    <div class="container">  
        <header style="background: url(header.jpeg); height: 194px;"> 
            <div class="row" >
                <div class="col-md-3">
        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              ...
              <li><a href="?m=pilkada"><span class="glyphicon glyphicon-calendar"></span> Pilkasis</a></li>
              <li><a href="?m=tanda_terima"><span class="glyphicon glyphicon-glyphicon glyphicon-cloud"></span> Coblos</a></li>
              <li><a href="?m=daftar_peserta"><span class="glyphicon glyphicon-glyphicon glyphicon-user"></span> Daftar Calon</a></li>
    ...
    <footer class="footer">
      <div class="container">
        <p>Copyright &copy; <?=date('Y')?> Smkn 8 Jember <em class="pull-right">diedit tahun 2019</em></p>
      </div>
    </footer>
    </body>
</html>